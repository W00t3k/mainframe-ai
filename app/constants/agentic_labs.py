...
AGENTIC_LABS = {
    "rakf-security": {
        ...
        "steps": [
            ...
            {
                "id": 3,
                "goal": "Exit the file view and browse SYS1.SECURE.CNTL(PROFILES) to see the access rules",
    ...
    "session-stack": {
        ...
        "steps": [
            ...
            },
            {
                ...
                "success_criteria": ["TSOAPPLS", "TSO APPLICATIONS"],

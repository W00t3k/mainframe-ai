//ENUMJOB  JOB (1),'UPLOAD ENUM',CLASS=A,MSGCLASS=A,
//         USER=HERC01,PASSWORD=CUL8TR
//*
//* Upload mainframed/Enumeration REXX to HERC01.REXX(ENUM)
//* Source: github.com/mainframed/Enumeration
//*
//ALLOC   EXEC PGM=IEFBR14
//DD1     DD DSN=HERC01.REXX,DISP=(NEW,CATLG),
...
//SYSPRINT DD SYSOUT=*
//SYSUT2  DD DSN=HERC01.REXX,DISP=SHR
//SYSIN   DD DATA,DLM='@@'
./ ADD NAME=ENUM
/* REXX */
...
EnumTsoTables: PROCEDURE EXPOSE (findingsVars)
  ...
  DO i = 8 TO ctltSize - 5 BY 12
    ...
    showTable = 1
    IF assessMode == 0 THEN DO
      /* Not in assess mode - only show AUTHCMD and    */
      /* AUTHTSF (if IDCAMS present)                    */
